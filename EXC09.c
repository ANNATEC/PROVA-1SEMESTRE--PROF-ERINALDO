...
//œ De R$ 2.8251,06 ate R$ 4.664,68: Aliquota de 22,5% (deducao de R$ 651,73)
...
float calcula (float salario)6,66 ate R$ 3.751,05: Aliquota de 15% (deducao de R$ 370,40)
//œ De R$ 3.7 {
	float m;
	if (salario <= 2112){
		m = 0.0;
